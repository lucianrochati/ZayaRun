...
urlpatterns = [
    ...
    path("treino/<int:planned_id>/concluir/", views_coach.complete_workout, name="complete_workout"),
    ...
    path("confirmar-sexo/", views_coach.confirm_sex, name="confirm_sex"),
    path("ciclo/config/", views_coach.cycle_setup, name="cycle_setup"),
    path("ciclo/registro/", views_coach.cycle_log, name="cycle_log"),
    path("ciclo/acao/", views_coach.cycle_action, name="cycle_action"),
    path("zaya/sugestao/<int:suggestion_id>/", views_coach.resolve_suggestion, name="resolve_suggestion"),
    path("zaya/autonomia/", views_coach.set_zaya_autonomy, name="set_zaya_autonomy"),
